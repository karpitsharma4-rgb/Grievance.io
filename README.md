...
Prerequisites
Node.js 18+ and npm
Backend running at http://localhost:5000 (see Backend Setup)
Installation
...
Login/Register → JWT token returned in response.data.data.token
Token stored in localStorage + Redux state
